      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 md:gap-3 group z-50" onClick={() => setMobileMenuOpen(false)}>
            <div className="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center font-mono text-xs md:text-sm font-bold tracking-tighter transition-transform group-hover:scale-105 bg-blue-600 text-white">
              RJ
            </div>
